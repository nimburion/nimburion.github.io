...
<div class="hero">
  ...
  <div class="hero-actions">
    <a href="/documentation/nimburion/getting-started/" class="btn btn-primary">Get Started</a>
...
<div style="max-width: 1200px; margin: 0 auto; padding: 0 var(--space-lg) var(--space-3xl);">
  <div class="card-grid">
    <div class="card">
      ...
      <a href="/documentation/nimburion/" class="card-link">
        Explore framework →
      </a>
    </div>
    ...
    <div class="card">
      ...
      <a href="/documentation/apigateway/" class="card-link">
        Learn more →
      </a>
    </div>
    ...
    <div class="card">
      ...
      <a href="/documentation/nimburion/guides/" class="card-link">
        Browse guides →
      </a>
    </div>
  </div>
