...
<section class="hero-grid">
  <div class="hero-copy">
    <span class="eyebrow">Core project</span>
    <h1>Nimburion framework documentation.</h1>
    <p class="hero-subtitle">
      Core framework guides for building production-grade Go microservices
  ...
  <aside class="hero-panel" aria-label="Nimburion docs sections">
...
<section class="section">
  <div class="section-head">
    <h2>Start here</h2>
    <p>Follow this order to understand capabilities and implementation boundaries.</p>
  </div>
