...
<section class="hero-grid">
  <div class="hero-copy">
    ...
    <div class="hero-actions">
      <a class="btn btn-primary" href="{{ '/wiki/apigateway/overview/' | relative_url }}">Open overview</a>
...
<section class="section">
  ...
  <div class="project-grid">
    <article class="project-card">
      ...
      <a href="{{ '/wiki/apigateway/overview/' | relative_url }}">Open page →</a>
    </article>
    <article class="project-card">
      <div class="project-head">
        <h3>Operations</h3>
      ...
      <a href="{{ '/wiki/apigateway/operations/' | relative_url }}">Open page →</a>
    </article>
    <article class="project-card">
      <div class="project-head">
      ...
      <a href="{{ '/wiki/apigateway/routing-and-policies/' | relative_url }}">Open page →</a>
    </article>
  </div>
</section>
